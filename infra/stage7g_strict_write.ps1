...
$result = [PSCustomObject]@{
  gate1_status=$g1.status; gate1_body=$g1.body; workflow_id=$workflowId;
...
$result | ConvertTo-Json -Depth 12 | Set-Content -Path 'C:\Users\rosic\Documents\GitHub\AI-BA-Agent\infra\stage7g_strict_result.json' -Encoding ascii
Write-Output 'WROTE_RESULT'
