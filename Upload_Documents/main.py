...
用法: python main.py --template template.docx --document input.pdf --output output.docx
"""
...
def main():
    ...
    parser.add_argument("--api-key", help="Anthropic API Key（或設置 ANTHROPIC_API_KEY 環境變量）")
