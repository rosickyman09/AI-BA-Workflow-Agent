...
# Load env files: root .env first, then infra/.env for LLM keys
load_dotenv()
load_dotenv(Path(__file__).resolve().parent.parent / "infra" / ".env", override=False)
...
async def generate_document(
    ...
    llm_provider: str = Form("openrouter"),  # openrouter | deepseek | anthropic | openai
